...
(function () {
  ...
  function restoreOriginalDOM() {
    ...
    if (uiBody && storyCap && storyCap.parentElement !== uiBody) {
    ...
    [sky, imgWrap, captionDiv, captionCnt, stats, statMeters, overlayBtns, mobStats, uiBar, uiBody, storyCap, menu, startCap].forEach(cleanStyles);
  ...
  function wireStowedMobileStatsClick(mobStats) {
    ...
    statElems.forEach(function (elem) {
      ...
      elem.addEventListener("click", function (e) {
        ...
        var textContent = (elem.textContent || "").trim();
        var val = getStatExactValue(id, textContent);
        showStatToast(label.toUpperCase(), val);
      });
    });
  }
  ...
  function ensureUISettingsOverlay() {
    ...
    baseBox.appendChild(createCustomSelect("Base Theme Preset", [
